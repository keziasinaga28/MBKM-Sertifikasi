                            ...
                            <div class="card">
                                <div class="card-header">
                                    <div class="card-head-row">
                                        <h4 class="card-title">FORM PENGUMPULAN BERKAS</h4>
                                    </div>
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <form action="proses.php?PageAction=tambah_berkas" method="POST" enctype="multipart/form-data">
                                                    <?php
                                                    include 'config.php';
                                                    $nim_nik = $_SESSION['nim_nik'];
                                                    ...
                                                    ?>
                                                        ...
                                                        <input type="hidden" id="id_daftar" name="id_daftar" value="<?php echo $id_daftar; ?>">

                                                        <div class=" form-group">
                                                            <label for="sertifikat">Sertifikat Kegiatan<span class="required-label">*</span></label>
                                                            <input type="file" class="form-control" name="sertifikat" id="sertifikat">
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="laporan">Laporan Kegiatan<span class="required-label">*</span></label>
                                                            <input type="file" class="form-control" name="laporan">
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="luaran">Luaran Kegiatan<span class="required-label">*</span></label>
                                                            <input type="file" class="form-control" name="luaran">
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="tanggal_mulai">Tanggal Mulai<span class="required-label">*</span></label>
                                                            <input type="date" class="form-control" name="tanggal_mulai" value="" id="date">
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="tanggal_mulai">Tanggal Selesai<span class="required-label">*</span></label>
                                                            <input type="date" class="form-control" name="tanggal_selesai" value="" id="date">
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="dokumentasi">Dokumentasi<span class="required-label">*</span></label>
