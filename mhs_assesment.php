                            ...
                            <div class="card">
                                <div class="card-header">
                                    <div class="card-head-row">
                                        <h4 class="card-title">ASSESMENT MBKM</h4>
                                    </div>
                                </div>
                                <div class="card-body">
                                    <div class="row">
                                                        ...
                                                        <div class="table-responsive">
                                                            <table id="add-row" class="display table table-striped table-hover">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    $view = mysqli_query($conn, "SELECT * FROM tb_daftar INNER JOIN tb_informasi on tb_daftar.nim_nik = tb_informasi.nim_nik 
                                                                    WHERE tb_daftar.nim_nik = $nim_nik");
                                                                    // $no = 1;
                                                                    while ($data = mysqli_fetch_array($view)) {
                                                                        $arr = explode(',', $data['matkul']);
                                                                    ?>

                                                                        <tr>
                                                                            <td>
                                                                                <center>
                                                                                    <a href='#' type='button' data-toggle='modal' data-target='#formulir<?= $data["nim_nik"] ?>' class='btn btn-sm btn-primary text-white'><i class='fas fa-eye'></i> view</a>
                                                                                </center>
                                                                            </td>
                                                                            <td>
                                                                                <center>
                                                                                    <a href='#' type='button' data-toggle='modal' data-target='#penerimaan<?= $data["nim_nik"] ?>' class='btn btn-sm btn-primary text-white'><i class='fas fa-eye'></i> view</a>
                                                                                </center>
                                                                            </td>
                                                                            <td>
                                                                                <center>
                                                                            ...
                                                                            <td>
                                                                                <?php $id_daftar = $data['id_daftar'] ?>
                                                                                <center><a <?= $data['status'] == 'Disetujui' ? "href='index.php?page=mhs_kumpul&id=$id_daftar'" : 'disabled' ?> class='btn btn-primary text-white'><i class='fas fa-file'></i> Upload File </a> </center>
                                                                            </td>
                                                                        </tr>

                                                                        <!--Modal Update-->
                                                                        <div class="modal fade" id="formulir<?php echo $data['nim_nik'] ?>" tabindex=" -1" role="dialog" aria-labelledby="modaleditlec" aria-hidden="true">
                                                                            <div class="modal-dialog modal-dialog-centered cascading-modal modal-lg" role="document">
                                                                                <div class="modal-content">
                                                                                    <div class="modal-header">
                                                                                        <h3 class="modal-title" id="modaleditlec">Formulir Pendaftaran</h3>
                                                                                    ...
                                                                                    <form action="proses.php?PageAction=tambah_daftar" method="POST" enctype="multipart/form-data">
                                                                                        ...
                                                                                        <div class="form-group">
                                                                                            <label for="nim_nik">Program Studi</label>
                                                                                            <input type="text" class="form-control" name="prodi" value="<?php echo $data['prodi'] ?>" readonly id="prodi">
                                                                                        </div>
                                                                                        <div class="form-group ">
                                                                                            <label for="nama">Angkatan</label>
                                                                                            <input type="text" class="form-control" name="angkatan" value="<?php echo $data['angkatan'] ?>" readonly id="angkatan">
                                                                                        </div>
                                                                                        <div class="form-group">
                                                                                            <label for="program">Program</label>
                                                                                            <input type="text" class="form-control" name="program" value="<?php echo $data['program'] ?>" readonly id="program">
                                                                                        </div>
                                                                                        <div class="form-group">
                                                                                            <label for="jenis_mbkm">Jenis MBKM</label>
                                                                                            <input type="text" class="form-control" name="jenis_mbkm" value="<?php echo $data['jenis_mbkm'] ?>" readonly id="jenis_mbkm">
                                                                                        </div>
                                                                                        <div class="form-group">
                                                                                            <label for="tempat_kegiatan">Tempat Kegiatan</label>
                                                                                            <input type="text" class="form-control" name="tempat_kegiatan" value="<?php echo $data['tempat_kegiatan'] ?>" readonly id="tempat_kegiatan">
                                                                                        </div>
                                                                                        <div class="form-group">
                                                                                        ...
                                                                                        <div class="form-group">
                                                                                            ...
                                                                                            <input type="text" class="form-control" name="semester" value="<?php echo $data['semester'] ?>" readonly id="semester">
                                                                                        </div>
                                                                                        </thead>
                                                            </table>

                                                            <!--Modal bukti penerimaan-->
                                                            <div id="penerimaan<?= $data['nim_nik'] ?>" class="modal fade" role="dialog">
