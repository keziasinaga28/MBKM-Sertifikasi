                                            ...
                                            <div class="table-responsive table-hover table-sales">
                                                <table class="table">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        $viewsekjur = mysqli_query($conn, "SELECT * FROM (tb_daftar LEFT JOIN tb_file ON tb_daftar.id_daftar = tb_file.id_daftar) LEFT JOIN tb_informasi ON tb_daftar.nim_nik = tb_informasi.nim_nik");
                                                        // $no = 1;
                                                        ...
                                                        ?>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <center>
                                                                        <a data-toggle="modal" data-target="#sertifikat<?php echo $data['nim_nik'] ?>" title="view" class="btn-sm btn-primary text-white" data-original-title="View"><i class="fas fa-eye">View</i></a>
                                                                    </center>
                                                                </td>
                                                                <td>
                                                                    <center>
                                                                        <a data-toggle="modal" data-target="#laporan<?php echo $data['nim_nik'] ?>" title="view" class="btn-sm btn-primary text-white" data-original-title="View"><i class="fas fa-eye">View</i></a>
                                                                    </center>
                                                                </td>
                                                                <td>
                                                                    <center>
                                                                        <a data-toggle="modal" data-target="#luaran<?php echo $data['nim_nik'] ?>" title="view" class="btn-sm btn-primary text-white" data-original-title="View"><i class="fas fa-eye">View</i></a>
                                                                    </center>
                                                                </td>
                                                                <td>
                                                                    <center>
                                                                        <a data-toggle="modal" data-target="#dokumentasi<?php echo $data['nim_nik'] ?>" title="view" class="btn-sm btn-primary text-white" data-original-title="View"><i class="fas fa-eye">View</i></a>
                                                                    </center>
                                                                </td>
                                                            ...
                                                            <!--Modal Sertifikat-->
                                                            <div id="sertifikat<?= $data['nim_nik'] ?>" class="modal fade" role="dialog">
                                                                <div class="modal-dialog modal-lg">
                                                                    <!-- Modal content-->
                                                                    <div class="modal-content">
                                                                        <div class="modal-header">
                                                                            <h4 class="modal-title">Sertifikat Kegiatan</h4>
                                                                        ...
                                                                        ?>
                                                                            <div class="modal-body" style="height: 600px">
                                                                                <object type="application/pdf" data="berkas/<?php echo $data['sertifikat'] ?>" width="100%" height="100%" frameborder="0" allowtransparency="true">
                                                                                </object>
                                                                            </div>
                                                                        <?php
                                                                        else :
                                                                        ?>
                                                                            <h2 class="p-5 mx-auto">Sertifikat Kegiatan tidak tersedia</h2>
                                                                        <?php endif; ?>
                                                            ...
                                                            <div id="laporan<?= $data['nim_nik'] ?>" class="modal fade" role="dialog">
                                                                <div class="modal-dialog modal-lg">
                                                                    <!-- Modal content-->
                                                                    <div class="modal-content">
                                                                        <div class="modal-header">
                                                                        ...
                                                                        ?>
                                                                            <div class="modal-body" style="height: 600px">
                                                                                <object type="application/pdf" data="berkas/<?php echo $data['laporan'] ?>" width="100%" height="100%" frameborder="0" allowtransparency="true">
                                                                                </object>
                                                                            </div>
                                                                        <?php
                                                                        else :
                                                                        ?>
                                                                            <h2 class="p-5 mx-auto">Laporan Kegiatan tidak tersedia</h2>
                                                                        <?php endif; ?>
                                                                        <div class="modal-footer">
                                                                            <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                                                                        </div>
                                                            ...
                                                            <!--Modal luaran kegiatan-->
                                                            <div id="luaran<?= $data['nim_nik'] ?>" class="modal fade" role="dialog">
                                                                <div class="modal-dialog modal-lg">
                                                                    <!-- Modal content-->
                                                                    <div class="modal-content">
                                                                        <div class="modal-header">
                                                                            <h4 class="modal-title">Luaran Kegiatan</h4>
                                                                            <button type="button" class="close" data-dismiss="modal">&times;</button>
                                                                        </div>
                                                                        <?php
                                                                        if ($data['luaran']) :
                                                                        ?>
                                                                            <div class="modal-body" style="height: 600px">
                                                                                <object type="application/pdf" data="berkas/<?php echo $data['luaran'] ?>" width="100%" height="100%" frameborder="0" allowtransparency="true">
                                                                                </object>
                                                                            </div>
                                                                        <?php
                                                                        else :
                                                                        ?>
                                                                            <h2 class="p-5 mx-auto">Luaran Kegiatan tidak tersedia</h2>
                                                                        <?php endif; ?>
                                                                        <div class="modal-footer">
                                                                            <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                                                                        </div>
                                                            ...
                                                            <!--Modal luaran kegiatan-->
                                                            <div id="dokumentasi<?= $data['nim_nik'] ?>" class="modal fade" role="dialog">
                                                                <div class="modal-dialog modal-lg">
                                                                    <!-- Modal content-->
                                                                    <div class="modal-content">
                                                                        <div class="modal-header">
                                                                        ...
                                                                        ?>
                                                                            <div class="modal-body" style="height: 600px">
                                                                                <object type="application/pdf" data="berkas/<?php echo $data['dokumentasi'] ?>" width="100%" height="100%" frameborder="0" allowtransparency="true">
                                                                                </object>
                                                                            </div>
                                                                        <?php
                                                                        else :
